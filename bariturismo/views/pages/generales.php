                    ...
                    <div class="cardHistoria card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text  text-light"><?php echo $value["descripcion"] ?></p>
                                ...
                                <button data-x="<?php echo $value["coordenadas_x"] ?>" data-y="<?php echo $value["coordenadas_y"] ?>" class="extraerC btn btn-sm btn-primary"> <i class="bi bi-geo-alt-fill"></i> <strong>Ubicación</strong></button>
