...
<div class="container-fluid" style="text-align: center;">
    ...
    <div class="container shadow p-3" style="background-color:#9acef8; border-radius:5px;">
        ...
        <div class="row justify-content-md-center">
            <div class="col col-xs-12 col-md-12 col-lg-12">
                ...
                <input type="password" name="contra_act" id="contra_act" class="form-control" value="" required>
