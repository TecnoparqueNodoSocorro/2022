            ...
            <section class="page-section">
                <div class="container">
                    <div class="bg-faded  rounded">
                        <img class="intro-img img-fluid  rounded"
            ...
            <div class="container" style="width:100%;">
                ...
                <form method="post">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <input type="password" class="form-control" id="pass" name="password" autocomplete="on"
                            placeholder="Contraseña" aria-label="passw" aria-describedby="passwordHelpInline">
                    </div>


                    <button type="submit" id="btnIniciar" class="btn btn-warning mt-3">Ingresar</button>
                </form>
            </div>
        </div>
