<div class="container">
    ...
    <div class="container mb-3 mt-2" style="background-color:#f8deb9;border-radius:5px;">
        <div class="row justify-content-md-center mt-2">
            ...
            <div class="col-6 col-xs-12 col-md-6 col-lg-6 mt-1">
                ...
                <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" value="" required>
            </div>
            <div class="col-12 mt-1">
                ...
                <select class="form-select mb-2" name="" id="seleccion_enfermedad" aria-label="Default select example">
    ...
    <div class="table-responsive mt-3 mb-5">
        <table class="table table-warning table-bordered">
            <thead id="thead_reporte" class="table-light">
             <!--    <tr>
            ...
            <tbody id="tbody_reporte_controles">
