...
function CrearUsuario() {
    if (document_user.value.trim() == "" || phone_user.value.trim() == "" || lastname_user.value.trim() == "" || name_user.value.trim() == "") {
        DatosIncompletos()
        ...
        nuevoUsuario = { cargo: 2, documento: document_user.value, telefono: phone_user.value, apellidos: lastname_user.value, nombres: name_user.value, clave: claveConfir.value }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("views/ajax/usuarios_ajax.php", { nuevoUsuario }, function (dato) {
                    ...
                    setTimeout(function () {
                        location.href = 'index.php?page=a_registrarEmpleado'
                    }, 1500);
                })
                Swal.fire({
                    icon: 'success',
