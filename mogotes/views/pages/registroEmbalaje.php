...
<h5 class="my-2">Registro de Embalaje</h5>
    ...
    <ul class="nav nav-tabs pt-3" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="bocadillo-tab" data-bs-toggle="tab" data-bs-target="#bocadillo"
                type="button" role="tab" aria-controls="bocadillo" aria-selected="true">Bocadillo</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="espejuelo-tab" data-bs-toggle="tab" data-bs-target="#espejuelo" type="button"
                role="tab" aria-controls="espejuelo" aria-selected="false">Espejuelo</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="arequipe-tab" data-bs-toggle="tab" data-bs-target="#arequipe" type="button"
                role="tab" aria-controls="arequipe" aria-selected="false">Arequipe</button>
        </li>
    </ul>
    ...
    <div class="tab-content" style="background-color:#e3f8e0;">
        <div class=" tab-pane active" id="bocadillo" role="tabpanel" aria-labelledby="bocadillo-tab">
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="espNav" placeholder="" aria-label="Username"
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="extrafino" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="veinte_t" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                <div class="col-6 col-sm-3">
                    <div class="input-group  mb-1">
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="venti_ocho" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="ochenta_cuatro" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="mooticos" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="mooticos_c" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                <div class="col-6 col-sm-3">
                    <div class="input-group  mb-1">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="unidades" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="moticos_unidades" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                <div class="col-6 col-sm-3">
                    <div class="input-group  mb-1">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="bocadillo_manzana" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="lonja" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
        ...
        <div class="tab-pane" id="espejuelo" role="tabpanel" aria-labelledby="espejuelo-tab">
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="pastilla_unidad" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="moticos_esp" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="veinte_esp" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="cuarente_esp" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="noventas_esp" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="mooticos_diez" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="mooticos_cinco" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
        ...
        <div class="tab-pane" id="arequipe" role="tabpanel" aria-labelledby="arequipe-tab">
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="caja_2" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                <div class="col-6 col-sm-3">
                    <div class="input-group  mb-1">
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="bocadillo_panelaU" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="bocadillo_panela" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
                <div class="col-6 col-sm-3">
                    <div class="input-group  mb-1">
                ...
                <div class="col-6 col-sm-3">
                    <input type="number" class="form-control" id="bocadillo_light" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6  col-sm-3">
                    <input type="number" class="form-control" id="herpos" placeholder="" aria-label="Username"
                        aria-describedby="basic-addon1">
                </div>
            </div>
