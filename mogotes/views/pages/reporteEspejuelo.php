<div class="container">
    ...
    <div class="container" style="background-color:#e3f8e0;">
        <div class="row pt-4">
            ...
            <div class="col-6  col-sm-3">
                <select class="form-select" id="lote_espejuelo"
            ...
            <div class="col-6 col-sm-3">
                <input type="number" class="form-control" id="azucarE" placeholder="" aria-label="Username"
        ...
        <div class="row">
            ...
            <div class="col-6  col-sm-3">
                <input type="number" class="form-control" id="aceite_oliva" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
            ...
            <div class="col-6 col-sm-3">
                <input type="number" class="form-control" id="pectina" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-6  col-sm-3">
                <input type="number" class="form-control" id="marmitasEsp" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
            ...
            <div class="col-6  col-sm-3">
                <input type="number" class="form-control" id="pailasEsp" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-6  col-sm-3">
                <input type="number" class="form-control" id="brixEsp" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-3">
                <input type="number" class="form-control" id="metalicasEsp" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        </div>
        ...
        <div class="row  pb-4">
            ...
            <div class="col-6  col-sm-3">
                <input type="number" class="form-control" id="redondaEsp" placeholder="" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <button type="submit" id="btnGuardarE" class="btn btn-mg btn-success mt-3 mb-5">Guardar</button>
