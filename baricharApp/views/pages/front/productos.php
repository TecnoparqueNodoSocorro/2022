<div class="home_bottomS">
    <div class="agregar">
        ...
        <div class="page_content">
            ...
            <div class="container">
                <a name="" id="agregar_producto" class="btn btn-warning" href="index.php?page=agregar_productos" role="button">NUEVO PRODUCTO</a>
            </div>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row" class="d-flex justify-content-center">
                                            ...
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modelId">
                                                <i class="bi bi-eye"></i>
                                            </button>
