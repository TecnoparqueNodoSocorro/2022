...
<!-- <div class="home_bottomS">
    <div class="container" >
        <div class="row"  style="justify-content: center;">
            <div class="contLogin col-sm-12 col-md-4 py-2">
                <div class="bottom_icon"><img src="views/images/login.png" alt="" title=""></div>
                ...
                <input type="button" class="btn btn-warning" value="INICIAR SESIÓN" style="float:none;">
...
<!-- <div class="container mt-5">
            ...
            <div class="contImagen col-sm-12 col-md-12 col-lg-6 "> <img src="views/images/logo.png" class="img img-fluid" alt="...">
                </div> 
            <div class="vh-100 col-sm-12">
                <div class="bottom_icon"><img src="views/images/login.png" alt="" title="" />
                </div>
